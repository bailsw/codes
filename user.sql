...
insert  into `booktype`(`booktype_id`,`booktype_name`) values (1,'qwer');
...
insert  into `buyer`(`buyer_id`,`buyer_username`,`buyer_password`,`buyer_salt`,`buyer_phone`,`buyer_email`,`buyer_lastLoginTime`,`buyer_registerTime`,`buyer_passwordQuestion`,`buyer_passwordAnswer`) values (1,'abc','900150983cd24fb0d6963f7d28e17f72',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'tom123','a8f5f167f44f4964e6c998dee827110c',NULL,'17822222222','123@qq.com',NULL,'2019-04-27 15:37:00','就读的小学叫什么？','123'),(4,'asdasd','a8f5f167f44f4964e6c998dee827110c',NULL,'17806255159','979541197@qq.com',NULL,'2019-05-05 13:08:40','就读的小学叫什么？','asd');
...
insert  into `order`(`order_id`,`order_userid`,`order_item`,`order_price`,`order_status`,`order_createdate`,`order_confirmdate`,`order_remark`,`order_address`,`order_item_amount`) values (1,123,'123',123,NULL,NULL,NULL,NULL,NULL,NULL),(2,234,'234',234,NULL,NULL,NULL,NULL,NULL,NULL);
